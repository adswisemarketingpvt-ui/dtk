          ...
          <div className="sm:col-span-2 md:col-span-2 grid grid-cols-2 gap-8 text-center md:text-left">
            ...
            <div className="flex flex-col items-center sm:items-start">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/accessories" className="text-amber-100 hover:text-white transition-colors">
                    Wholesale
                  </Link>
                </li>
              </ul>
            ...
            <div className="flex flex-col items-center sm:items-start">
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/return-policy" className="text-amber-100 hover:text-white transition-colors">
                    Return Policy
                  </Link>
                </li>
                <li>
                  <Link to="/shipping-policy" className="text-amber-100 hover:text-white transition-colors">
                    Shipping Policy
                  </Link>
                </li>
              </ul>
